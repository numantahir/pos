    ...
    <body>
    	<?php
			...
			<div id="reportContainer" style="width:950px;">
                ...
                <?php $output = $purchase->list_periodical_purchases($start_date, $end_date); ?>
                ...
                <div style="width:350px;float:right;">
                	<table class="table">
                        ...
                        <tr>
                            ...
                            <td class="text-right"><?php echo number_format($output["purchase_amount"], 2); ?></td>
                        </tr>
                        <tr>
                        	<th>Amount Paid</th>
                            <td class="text-right"><?php echo number_format($output["paid_amount"], 2); ?></td>
                        </tr>
                    </table>
                </div>
